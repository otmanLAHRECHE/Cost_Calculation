...
function DashboardAdminContent() {
  ...
  const clickUsers = () =>{
      ...
      setPage([true,false])
      setToolBar("Liste des users")
  };

  const clickEmplacements = () =>{
  
    setPage([false,true])
    setToolBar("Emplacements de stock")
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            <Button color="inherit" startIcon={<ThreePRoundedIcon />}>Admin</Button>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Divider />
          <List component="nav">
                <ListItemButton selected = {page[0]} onClick={clickUsers}>
                  <ListItemIcon>
                    <GroupIcon />
                  </ListItemIcon>
