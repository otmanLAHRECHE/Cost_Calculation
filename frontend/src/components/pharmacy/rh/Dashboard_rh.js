...
import Cuisine_Services from '../cuisine/Cuisine_services';
...
function DashboardContent_Rh() {
  ...
  const clickEtat = () =>{
      ...
      setToolBar("Etat de solde")
  };

  const clickPers= () =>{
  
    setPage([false,true,false,false])
    setToolBar("Personnels")
  ...
  const clickServices = () =>{
    ...
    setToolBar("Les services")
  
  };
  const clickGrades= () =>{
  
    setPage([false,false,false,true])
    setToolBar("Les grades")
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="absolute" open={open}>
          <Toolbar
            sx={{
              pr: '24px',
              backgroundColor: '#34eb3d', // keep right padding when drawer closed
            }}
          >
            <IconButton
              edge="start"
          ...
          <List component="nav">
            <Divider sx={{ my: 1 }} />
                ...
                <ListItemButton selected = {page[0]} onClick={clickEtat}>
                  ...
                  <ListItemText primary="Etat de solde"/>
                </ListItemButton>
                <ListItemButton selected={page[1]} onClick={clickPers}>
                  <ListItemIcon>
                ...
                <ListItemButton selected={page[2]} onClick={clickServices}>
                  <ListItemIcon>
                    <CategoryIcon />
                  </ListItemIcon>
                  <ListItemText primary="Les services" />
                </ListItemButton>
                <ListItemButton selected={page[3]} onClick={clickGrades}>
                  <ListItemIcon>
                    <GradeIcon />
                  </ListItemIcon>
                  <ListItemText primary="Les grades" />
                </ListItemButton>
